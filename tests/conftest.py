...
@pytest.fixture
def mocked_stac_collections_url():
    """Mock responses to the STAC collections endpoint made with the "requests" library. Return the mocked collections URL."""
    with responses.RequestsMock() as resp:
        url = "http://mocked_stac_catalog_url_2/"
        ...
        resp.add(url=url + "/catalog/collections", json=json, status=200)

        yield url + "/catalog/collections"


@pytest.fixture
def mocked_stac_catalog_collection_url():
    """Mock responses to a STAC collection made with the "requests" library. Return the mocked collection URL."""
    with responses.RequestsMock() as resp:
        url = "http://mocked_stac_catalog_url"
        ...
        resp.get(url=url + "/catalog/collections/toto:S1_L1", json=json, status=200)
        yield url + "/catalog/collections/toto:S1_L1"
