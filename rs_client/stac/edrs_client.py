...
"""EdrsClient class implementation."""
...
class EdrsClient(StacBase):
    ...
    def __init__(  # pylint: disable=too-many-arguments, too-many-positional-arguments
        ...
        **kwargs: dict[str, Any],
        ...
        """
        Initializes an EdrsClient instance.
        ...
        super().__init__(
            ...
            None,
            logger,
            get_href_service(rs_server_href, "RSPY_HOST_EDRS") + "/edrs/",
            **kwargs,
        )
    ...
    def href_service(self) -> str:
        """
        Return the RS-Server EDRS URL hostname.
        This URL can be overwritten using the RSPY_HOST_EDRS env variable (used e.g. for local mode).
        Otherwise it should just be the RS-Server URL.
        """
        return get_href_service(self.rs_server_href, "RSPY_HOST_EDRS") + "/edrs"
