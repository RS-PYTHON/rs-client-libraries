...
async def past_adf_conversion(
    ...
    if period_in_hours == 0:
        ...
        cql2_filter = substitute_values(
            ...
            {
                "start_datetime": period_start.isoformat().replace("+00:00", ".000000Z"),
                "end_datetime": period_end.isoformat().replace("+00:00", ".000000Z"),
            },
        )
        ...
        while start <= period_end:
            ...
            cql2_filter = substitute_values(
                cql2_filter_without_date,
                {
                    "start_datetime": start.isoformat().replace("+00:00", ".000000Z"),
                    "end_datetime": stop.isoformat().replace("+00:00", ".000000Z"),
                },
            )
