...
async def _stage_input_adfs_alternative(
    ...
    """
    logger = get_run_logger()
    logger.info("FAKE STAGING - skipping AUXIP staging for testing purposes")
    if input_adfs["name"] == "FRO":
        item_collection = ItemCollection.from_dict(
            {'type': 'FeatureCollection', 'features': [{'type': 'Feature', 'stac_version': '1.1.0', 'stac_extensions': ['https://stac-extensions.github.io/file/v2.1.0/schema.json', 'https://stac-extensions.github.io/timestamps/v1.1.0/schema.json', 'https://stac-extensions.github.io/external-ids/v1.0.0/schema.json', 'https://home.rs-python.eu/ownership-stac-extension/v1.1.0/schema.json', 'https://stac-extensions.github.io/alternate-assets/v1.1.0/schema.json', 'https://stac-extensions.github.io/authentication/v1.1.0/schema.json'], 'id': 'S3A_OPER_MPL_ORBRES_20200117T000000_20200127T000000_0001', 'geometry': None, 'properties': {'owner': 'agrosu', 'created': '2020-01-20T06:50:46Z', 'expires': '2026-06-24T14:26:35.210620Z', 'updated': '2026-05-25T14:26:35.182540Z', 'datetime': '2020-01-17T00:00:00Z', 'platform': 'sentinel-3a', 'published': '2026-05-25T14:26:35.182517Z', 'externalIds': [{'value': '9b6f2c3a-1e6a-4f5b-9f3a-0c7a2d4f8e91', 'scheme': 'auxip'}], 'end_datetime': '2020-01-27T00:00:00Z', 'product:type': 'AX___FRO_AX', 'constellation': 'sentinel-3', 'start_datetime': '2020-01-17T00:00:00Z', 'processing:facility': 'EUMETSAT', 'auth:schemes': {'apikey': {'type': 'apiKey', 'description': 'API key generated using https://apikeymanager.dev-rspy-ovh.esa-copernicus.eu/docs#/Manage%20API%20keys/get_new_api_key_auth_api_key_new_get', 'name': 'x-api-key', 'in': 'header'}, 'openid': {'type': 'openIdConnect', 'description': 'OpenID Connect', 'openIdConnectUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/.well-known/openid-configuration'}, 'oauth2': {'type': 'oauth2', 'description': 'OAuth2+PKCE Authorization Code Flow', 'flows': {'authorizationCode': {'authorizationUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/protocol/openid-connect/auth', 'tokenUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/protocol/openid-connect/token', 'scopes': {}}}}, 's3': {'type': 's3', 'description': 'S3'}}}, 'links': [{'rel': 'collection', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP', 'type': 'application/json'}, {'rel': 'parent', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP', 'type': 'application/json'}, {'rel': 'root', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/', 'type': 'application/json', 'title': 'RS-PYTHON STAC Catalog'}, {'rel': 'self', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP/items/S3A_OPER_MPL_ORBRES_20200117T000000_20200127T000000_0001', 'type': 'application/geo+json'}], 'assets': {'S3A_OPER_MPL_ORBRES_20200117T000000_20200127T000000_0001.EOF': {'href': 's3://rs-dev-cluster-temp/agrosu/TEST_FLOW_AUXIP/S3A_OPER_MPL_ORBRES_20200117T000000_20200127T000000_0001/S3A_OPER_MPL_ORBRES_20200117T000000_20200127T000000_0001.EOF', 'type': 'application/octet-stream', 'file:size': 0, 'file:checksum': 'replace_with_md5', 'eviction_datetime': '2020-01-27T00:00:00.000Z', 'auth:refs': ['s3']}}, 'collection': 'TEST_FLOW_AUXIP'}]}
        )
    else:
        item_collection = ItemCollection.from_dict(
            {'type': 'FeatureCollection', 'features': [{'type': 'Feature', 'stac_version': '1.1.0', 'stac_extensions': ['https://stac-extensions.github.io/file/v2.1.0/schema.json', 'https://stac-extensions.github.io/timestamps/v1.1.0/schema.json', 'https://stac-extensions.github.io/external-ids/v1.0.0/schema.json', 'https://home.rs-python.eu/ownership-stac-extension/v1.1.0/schema.json', 'https://stac-extensions.github.io/alternate-assets/v1.1.0/schema.json', 'https://stac-extensions.github.io/authentication/v1.1.0/schema.json'], 'id': 'S3A_OPER_MPL_ORBSCT_20160216T192404_99999999T999999_0002', 'geometry': None, 'properties': {'owner': 'agrosu', 'created': '2017-03-22T16:30:46Z', 'expires': '2026-06-24T14:26:34.702460Z', 'updated': '2026-05-25T14:26:34.694345Z', 'datetime': '2016-02-16T19:24:04Z', 'platform': 'sentinel-3a', 'published': '2026-05-25T14:26:34.694325Z', 'externalIds': [{'value': 'c4e8a1b2-7d5f-4a3c-8e9f-1b2d3c4a5e6f', 'scheme': 'auxip'}], 'end_datetime': '9999-12-31T23:59:59Z', 'product:type': 'AX___OSF_AX', 'constellation': 'sentinel-3', 'start_datetime': '2016-02-16T19:24:04Z', 'processing:facility': 'EUMETSAT', 'auth:schemes': {'apikey': {'type': 'apiKey', 'description': 'API key generated using https://apikeymanager.dev-rspy-ovh.esa-copernicus.eu/docs#/Manage%20API%20keys/get_new_api_key_auth_api_key_new_get', 'name': 'x-api-key', 'in': 'header'}, 'openid': {'type': 'openIdConnect', 'description': 'OpenID Connect', 'openIdConnectUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/.well-known/openid-configuration'}, 'oauth2': {'type': 'oauth2', 'description': 'OAuth2+PKCE Authorization Code Flow', 'flows': {'authorizationCode': {'authorizationUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/protocol/openid-connect/auth', 'tokenUrl': 'https://iam.dev-rspy-ovh.esa-copernicus.eu/realms/rspy/protocol/openid-connect/token', 'scopes': {}}}}, 's3': {'type': 's3', 'description': 'S3'}}}, 'links': [{'rel': 'collection', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP', 'type': 'application/json'}, {'rel': 'parent', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP', 'type': 'application/json'}, {'rel': 'root', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/', 'type': 'application/json', 'title': 'RS-PYTHON STAC Catalog'}, {'rel': 'self', 'href': 'https://dev-rspy-ovh.esa-copernicus.eu/catalog/collections/agrosu:TEST_FLOW_AUXIP/items/S3A_OPER_MPL_ORBSCT_20160216T192404_99999999T999999_0002', 'type': 'application/geo+json'}], 'assets': {'S3A_OPER_MPL_ORBSCT_20160216T192404_99999999T999999_0002.EOF': {'href': 's3://rs-dev-cluster-temp/agrosu/TEST_FLOW_AUXIP/S3A_OPER_MPL_ORBSCT_20160216T192404_99999999T999999_0002/S3A_OPER_MPL_ORBSCT_20160216T192404_99999999T999999_0002.EOF', 'type': 'application/octet-stream', 'file:size': 0, 'file:checksum': 'replace_with_md5', 'eviction_datetime': '9999-12-31T23:59:59.000Z', 'auth:refs': ['s3']}}, 'collection': 'TEST_FLOW_AUXIP'}]}
        )
    return input_adfs["name"], input_adfs["type"], (True, item_collection)
