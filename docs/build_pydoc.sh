...
BASE_FOR_MKDOCS_LOCATIONS="rs-client-libraries/docs/doc/pydoc/"

# LIST OF MODULES IN THE PROJECT
declare -a MODULE_NAMES=("rs_client" "rs_common" "rs_workflows")
...
create_documentation_for_rs_client_libraries() {
